...
class TestVisualization(unittest.TestCase):
    ...
    def test_draw_boxes_empty(self):
        ...
        image_with_boxes = draw_boxes(
            self.test_image.copy(), empty_boxes, empty_scores, empty_labels, self.class_names
        )
    ...
    def test_save_detection_crops(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            save_detection_crops(self.test_image, self.test_boxes, self.test_scores, output_dir)
