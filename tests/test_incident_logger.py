...
class TestIncidentLogger(unittest.TestCase):
    ...
    def test_update_incident_status(self):
        ...
        # Log incident
        incident_id = self.logger.log_incident(camera_id="camera_1", confidence=0.75, detections=1)
    ...
    def test_get_incidents_with_filters(self):
        ...
        self.logger.log_incident(camera_id="camera_2", confidence=0.65, detections=2)
        self.logger.log_incident(camera_id="camera_1", confidence=0.95, detections=1)
    ...
    def test_get_statistics(self):
        ...
        # Log incidents
        self.logger.log_incident(camera_id="camera_1", confidence=0.85, detections=1)
        self.logger.log_incident(camera_id="camera_2", confidence=0.75, detections=2)
...
class TestIncidentLoggerEdgeCases(unittest.TestCase):
    ...
    def test_invalid_incident_id(self):
        ...
        # Should not crash
        self.logger.update_incident_status(incident_id=99999, status="resolved")
