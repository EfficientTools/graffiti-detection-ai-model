...
class TestAlertManager(unittest.TestCase):
    ...
    def test_alert_manager_with_enabled_channels(self):
        ...
        config = {
            ...
            "webhook": {"enabled": True, "url": "https://test.com/webhook", "headers": {}},
            "push_notification": {
                "enabled": True,
                "provider": "onesignal",
                "api_key": "test-key",
        ...
        self.assertTrue(
            any(isinstance(channel, PushNotificationAlert) for channel in manager.alert_channels)
        )
...
class TestDiscordAlert(unittest.TestCase):
    ...
    def test_discord_alert_send(self, mock_post):
        ...
        config = {"webhook_url": "https://discord.com/api/webhooks/test", "include_image": False}
