...
def parse_args():
    ...
    parser.add_argument(
        "--output-dir", type=str, default="data", help="Output directory for organized dataset"
    )
    ...
    parser.add_argument(
        "--validate", action="store_true", help="Validate annotations before organizing"
    )
...
def main():
    ...
    print(
        f"Split ratios: train={args.split[0]:.2f}, val={args.split[1]:.2f}, test={args.split[2]:.2f}"
    )
