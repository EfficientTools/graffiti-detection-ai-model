...
def parse_args():
    ...
    parser.add_argument(
        "--img-size", type=int, default=None, help="Input image size (overrides config)"
    )

    parser.add_argument(
        "--device", type=str, default=None, help="Device to use (0, 1, ..., or cpu)"
    )
    ...
    parser.add_argument("--name", type=str, default="graffiti-detection", help="Experiment name")
